...
const (
	header            = "// Code generated by github.com/sylvan/auro/toolkits/cmd/gen-grpc. DO NOT EDIT.\n"
	defaultRuntimePkg = "github.com/grpc-ecosystem/grpc-gateway/runtime"
)
...
var (
	// Example:
	// go run "github.com/sylvan/auro/toolkits/cmd/gen-grpc" -c config
	// go run "github.com/sylvan/auro/toolkits/cmd/gen-grpc" -c $HOME/{project}/config
