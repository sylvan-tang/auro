package com.sylvan.soteria.bigdata.files

import com.sylvan.soteria.app.bigdata.files.{ SmallFiles, SmallFilesSetting }
import com.sylvan.soteria.infrastructure.spark.SparkAPI
