...
目标声明：在我生命接下来的日子里，我的体重不会超过 110 斤；身体没有慢性病痛；不会染上恶疾

当前状态：体重为 110 斤左右；有腰椎间盘突出

具体承诺：
1. 在 35 岁时通过运动，摆脱腰椎间盘突出的影响

执行计划：
1. 每天记录饮食，控制糖分和垃圾食品的摄入，每周不能食用碳酸饮料超过一次
2. 每周坚持运动达 7 小时
...
当前状态：用于投资的资产 * 平均投资年收益率 = 年度支出 * 0.01
...
| 日期 | 目标 | 完成状态 |
| ---- | ---- | ---- |
| 2024-04-07 | 找到一个实现远程办公的方式 | |
| 2030-04-07 | 成为自由职业者，不再受雇于公司 | |
| 2050-04-07 | 退休 | |

执行计划：
1. 在 2024-04-07 之前，每个月都安排一项与远程办公相关的任务，向着远程办公的目标前进
...
| 日期 | 目标 | 完成状态 |
| ---- | ---- | ---- |
| 2030-04-07 | 本项目有 1000 关注，平均每月有一次 commit | |
| 2035-04-07 | 学会木雕 | |

执行计划：
1. 每个月有一个分享主题，撰写之后 push 到 github 项目中
2. 每周学习时间不少于 14 个小时
