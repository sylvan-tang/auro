...
public class FlywaySchemaHistoryDO implements Serializable {
  ...
  private static final long serialVersionUID = -1246875474;
  ...
  public FlywaySchemaHistoryDO(FlywaySchemaHistoryDO value) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FlywaySchemaHistoryDO (");
